...
public class DbHelper {
    ...
    public static int getAge(Date birthDate){
        ...
        long diff = currentDateTime - birthDateTime;
        if (diff > 0){
            diff = diff/1000;
    ...
    throws Exception{
        ...
        //preparedStatement.setString(7,String.valueOf(getAge(user.birthday_as_date)));
    ...
    public int saveUserImages(List<UserImage> images)
    throws Exception{
        String query = "INSERT INTO images(user_id,picture_url)";
        query += " VALUES(?,?)";
    ...
    public int savePages(long userId, List<Page> pagesList)
    throws Exception {
...
//        }
    ...
    public int savePage(long userId, Page page)
    throws Exception{
        String query="INSERT INTO interests(user_id,page_id,name,category)";
        query+=" VALUES(?,?,?,?)";
    ...
    public User getCommonUser(User mu,ResultSet resultSet)
    throws Exception{
        try{
            mu.id=resultSet.getLong("uid");
        }catch(Exception ex){
            mu.id=resultSet.getLong("id");
        }
        mu.facebook_user_id=resultSet.getString("user_id");
        mu.name=resultSet.getString("name");
        mu.location=resultSet.getString("location");
        mu.profile_pic_url=resultSet.getString("profile_pic_url");
        mu.profile_url=resultSet.getString("profile_url");
        mu.profile_id=resultSet.getString("profile_id");
        mu.age=resultSet.getInt("age");
        
        return mu;
    }
    
    public List<UserMatch> getMatchedUsers(long userId)
    throws Exception{
    ...
    public List<PotentialMatchUser> getPotentialMatchingUsers(long userId)
    throws Exception{
